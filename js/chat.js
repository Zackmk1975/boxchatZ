...
var possibleInput = {
    ...
    "help": function () {
        ...
        responseText("Something like &quot;Zack, please show me Mees&rsquo; best work&quot;")
    ...
    "what your name": function () {
        responseText("My name is Zack")
        commandReset(0);
        return
    },
    ...
    "about": function () {
        responseText("This is me, Zack's maker, Mees Rutten");
    ...
    "contact": function () {
        responseText("email: <a href='mailto:test@gmail.com?Subject=Hello%20Mees' target='_top'>send me a message</a>");
        responseText("Twitter: <a href='https://twitter.com/#'>@MeesRttn</a>");
        commandReset(7);
        return
    },
    "commands": function () {
        responseText("This is a list of commands Zack knows:")
        responseText("help, best work, about, vision, experience, hobbies / interests, contact, rick roll");
        commandReset(8);
        return
    },
    "facebook": function () {
        responseText("your facebook")
        responseText("facebook: <a href='https://www.facebook.com/profile.php?=75548495'  target='_blank'>Your facebook</a>");
        commandReset(8);
        return
    },
    "rick roll": function () {
...
var reactionInput = {
    "best work": function () {
        ...
        responseText("On this GitHub page you'll find everything about Zack");
        responseText("<a href='#'>Zack on GitHub</a>")
        animationCounter = 1;
        return
    },
    "about": function () {
